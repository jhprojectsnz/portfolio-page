    ...
    <section className="about-section" id="about">
      ...
      >
        ...
        <p className="about-text main-text">
          ...
          thinking, problem-solving, and attention to detail. These skills have
          proven invaluable in my transition to web development, where I
          ...
          to life. In the same way that a scientist designs experiments to test
          hypotheses, a web developer designs websites and applications to meet
          user needs.
          <br />
          <br />
