    ...
    return (
        ...
        >   
            ...
            <div className="btn-container">
                {data.url && <a href={data.url} target='_blank' rel="noreferrer" className='button project-btn'>Demo<FaAngleRight/></a>}
                {data.github && <a href={data.github} target='_blank' rel="noreferrer" className='button project-btn'>GitHub<FaAngleRight/></a>}
            </div>
        </motion.div>
    )
}
